...
#define API_KEY "AIzaSyBpJ7-WNfSKbZISxUt_QpYzFvot1WRlPfw"
//  RTDB URLefine the RTDB URL */
#define DATABASE_URL "https://colorbase-1c24b-default-rtdb.firebaseio.com/"
...
void loop() {
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0)) {
    ...
    if (Firebase.RTDB.setInt(&fbdo, "test/int", count)) {
      ...
      // I want only if count is passed
